<%-- 
    Document   : newvendor
    Created on : 10 Oct, 2019, 9:54:15 AM
    Author     : piyush
--%>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <%
                                String user=(String)session.getAttribute("lid");
                                out.print(user);
                             %>
                           <i class="fa fa-angle-down"></i></h4>
                            <div class="dropdown-menu">                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Darshan Bhamare <i class="fa fa-angle-down"></i></h4>
            ...
            <div>
                            ...
                            <p><td>Email id:</td>
                                <td>
                            <input type="email" name="email" min="0">
                        </td>
                        </p>
                            </tr>
                                        <div> 
                            <tr>
                            <p><td>Login password:</td>
                                <td>
                            <input type="password" name="password" min="0">
                        </td>
                        </p>
                            </tr>
                        </div>
