<%-- 
    Document   : adminfront
    Created on : 5 Oct, 2019, 12:04:05 PM
    Author     : piyush
--%>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                             ...
                             <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="ongoing.jsp">Send Product Requests</a></li>
                                    <li><a href="table-layout.html">Received Quotations</a></li>
                                </ul>
                            </li>
...
String sql = "SELECT loginid FROM login where dept='admin'";
